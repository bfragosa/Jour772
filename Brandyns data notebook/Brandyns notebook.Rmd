...
**Nicole** \### For 5A, I took the dataset and filtered for two factors: dates before Sept. 3, 2020 and female in the gender column. I grouped the newly filtered data by the column "armed_with," in order to see the counts of females by what weapons they were (or weren't) carrying when killed by police.
