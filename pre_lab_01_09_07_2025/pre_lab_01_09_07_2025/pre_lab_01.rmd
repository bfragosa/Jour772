...
79366 observations of 9 variables
...
**its showing the amount of classes that were offered during each year starting at 2017**
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Its now showing the years that UMD offered the most amount of classes**
...
**we grouped them by term and department to see how many courses were offered in each term**
...
Compared to the previous codeblock, what has changed and how did that affect the result? **we used the sum function to add up all the seats and it shows how many seats were filled in each course during each year in descending order starting with the year that offered the most courses**
...
Compared to the previous codeblock, what has changed and how did that affect the result? What do the top terms have in common? **this code block adds the mean and medium function and added the data to our set. The top terms filter our data regarding seats in each offered course.**
...
**We added the min and max functions and it now shows us what department had the highest and lowest number of seats. The data is sorted by which department had the highest number of seats and goes in a descending order.**
...
1.  How many courses were offered during covid (2020-2021).

2.  What year/term offered the lowest amount of seats.

3.  what instructor offered the highest amount of seats.
