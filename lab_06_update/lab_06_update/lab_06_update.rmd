...
**Write the answer: Carroll has the most with 448 calls, Cecil is second with 438 calls, and Allegany has the least with 418 calls.**
...
**Write answer here: The biggest outlier was Allegany receiving 50 calls in August, the highest number of calls compared to the other two counties. Something that is noteworthy and makes sense is that all three counties experienced their highest total calls during the summer. This is probably because more people are outside due to the warmer weather, which also means more emergencies, crimes, etc.**
...
**Write answer here: 314 GROVE NECK RD EARLEVILLE, MD	in Cecil county had the most with 15 calls**
...
**Write the answer here: 21217 has the most with 774 calls, 21223 with 525 calls, 21202 with 325 calls, 21213 with 324 calls, 21201 with 321 calls, 21216 with 224 calls and 21205 has the least with 211 calls.**
...
21217 has the highest rate of calls per 1,000 people with 20.8%. 

```{r}
#Neighboorhoods listed in the 21217 zip code.
baltimore_911_with_demographics %>%
...
**Write the answer here: Penn north is located by a metro stop, I'm assuming that Penn north has a prominent drug problem because when I looked up Penn North Baltimore, the top results showed multiple rehab/ health initiatives for area residents. Sandtown-Winchester is a close second, with crime being rooted in this neighborhoods history. Abandoned homes, rioting, economic depression, crime and so on, it was reported that in 2015, 3% of the neighborhoods population was incarcerated, so there is definitely a number of different factors playing into the number of calls made to police. The third neighborhood receiving the most calls was Upton, and this one is sad because this neighborhood holds a lot of black history, but due to segregation forcing black residents across the city into specific neighborhoods in Baltimore, one of which being Upton, families had to share tiny apartments, rise in drinking and crime began, higher income black families started moving out, and now efforts to revitalize Upton back to what it once was is in progress.** 
